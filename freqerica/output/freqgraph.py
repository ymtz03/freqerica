...
class Outputter:
    ...
    def save(self):
        ...
        data_save = data_save.replace('/*n_qubit*/'      , str(self.n_qubit))
        data_save = data_save.replace('/*n_trott_step*/' , str(self.n_trott_step))
        data_save = data_save.replace('/*ngate*/'        , ','.join(map(shortstr_int, self.ngate          )))
        data_save = data_save.replace('/*time_sim*/'     , shortstr(self.time_sim))
        ...
        data_save = data_save.replace('/*spectrum_exact*/', ','.join(map(shortstr, self.spectrum_exact.real)))
        data_save = data_save.replace('/*spectrum_trott*/', ','.join(map(shortstr, self.spectrum_trott.real)))
